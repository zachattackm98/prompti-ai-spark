            ...
            >
                ...
                >
                  ...
                  <SelectContent className="bg-slate-800 border-purple-500/30 z-50">
                    {dialogStyles.map((style) => (
                      <SelectItem key={style.value} value={style.value} className="text-white hover:bg-slate-700 focus:bg-slate-700">
                        {style.label}
                      </SelectItem>
                    ))}
                  </SelectContent>
              ...
              <div>
                ...
                >
                  ...
                  <SelectContent className="bg-slate-800 border-purple-500/30 z-50">
                    {languages.map((lang) => (
                      <SelectItem key={lang.value} value={lang.value} className="text-white hover:bg-slate-700 focus:bg-slate-700">
                        {lang.label}
                      </SelectItem>
                    ))}
                  </SelectContent>
