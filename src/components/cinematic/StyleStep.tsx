...
import { ChevronLeft, Sparkles, Wand2, Crown } from 'lucide-react';
    ...
    return (
      ...
      >
        <div className="text-center space-y-2 sm:space-y-3">
          ...
          <p className="text-gray-300 text-sm sm:text-base">Enhance your cinematic vision with style references</p>
        </div>

        <UpgradePrompt
          feature="Style Reference Enhancement"
